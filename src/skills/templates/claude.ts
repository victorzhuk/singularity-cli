...
Habit color is a hex color string (e.g. \`#ff6b6b\`). Pass the value exactly as provided;
do not transform or normalize. Omit the field entirely when not specified.
`;
}
